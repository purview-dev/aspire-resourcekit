...
If tests or bootstrap code currently pass args directly, convert to `OptionsHelper.Assign<THostOptions>(...)`:
...
- Replace direct key/value arg strings with `OptionsHelper.Assign<THostOptions>(...)` where practical.
